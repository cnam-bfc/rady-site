...
// On modifie l'ingrédient en base de données
try {
    $sqlQuery = 'UPDATE IngredientsRecettes SET quantite = :quantite, unite = :unite WHERE idRecette = :idRecette AND idIngredient = :idIngredient';
    $sqlStatement = $mysqlClient->prepare($sqlQuery);
    $sqlStatement->execute([
        'idRecette' => $recette,
