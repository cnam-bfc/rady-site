...
// On modifie l'ustensile en base de données
try {
    $sqlQuery = 'UPDATE UstensilesRecettes SET quantite = :quantite, unite = :unite WHERE idRecette = :idRecette AND idUstensile = :idUstensile';
    $sqlStatement = $mysqlClient->prepare($sqlQuery);
    $sqlStatement->execute([
        'idRecette' => $recette,
